...
namespace TicTacToeBot
{
    ...
    {
        // Паттерны атаки бота.
        private readonly GamePattern[] _attackPatterns =
        {
            new GamePattern("11111", 100000), new GamePattern("011110", 7000), new GamePattern("011112", 3000),
            new GamePattern("211110", 3000), new GamePattern("0101110", 3000), new GamePattern("0111010", 3000),
            new GamePattern("0011100", 2000), new GamePattern("1010101", 2000), new GamePattern("001112", 1000),
            new GamePattern("211100", 1000), new GamePattern("00110100", 1000), new GamePattern("00101100", 1000),
            new GamePattern("00011000", 200)
        };

        private readonly string _botXO;

        // Паттерны обороны бота.
        private readonly GamePattern[] _defPatterns =
        {
            new GamePattern("22222", 100000), new GamePattern("022220", 7000), new GamePattern("022221", 4000),
            new GamePattern("122220", 4000), new GamePattern("0202220", 4000), new GamePattern("0222020", 4000),
            new GamePattern("0022200", 2000), new GamePattern("2020202", 2000), new GamePattern("002221", 1000),
            new GamePattern("122200", 1000), new GamePattern("00220200", 1000), new GamePattern("00202200", 1000),
            new GamePattern("00022000", 200)
        };

        private readonly string _enemyXO;

        private readonly Random _random = new Random();

        // преобразует значения CellState в "0","1","2".
        private readonly Dictionary<CellState, String> _XOmap = new Dictionary<CellState, string>();
        ...
        public override Cell Step()
        {
            ...
            if (markedPoints.Count != 0)
            {
                ...
                foreach (Point point in potentialPoints)
                {
